    ...
    return function() {
        ...
        function() {
            function Iti(input, options) {
                ...
                this.hadInitialPlaceholder = Boolean(input && input.getAttribute("placeholder"));
            }
            _createClass(Iti, [ {
                key: "_init",
                ...
                value: function _cap(number) {
                    ...
                    return max && number && number.length > max ? number.substr(0, max) : number;
                }
            }, {
                ...
                value: function _updateFlagFromNumber(originalNumber) {
                    ...
                    } else if ( number && number.charAt(0) === "+" && numeric.length) {
